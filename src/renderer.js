...
export class Renderer{
    ...
    getPressedKeys(){
      return indexesOf(sdl.keyboard.getState(), true).map((i) => sdl.keyboard.getKey(i))
    }
    keyPressed(key){
      return sdl.keyboard.getState()[sdl.keyboard.SCANCODE[sdl.keyboard.getScancode(key)]]
    }
    mousePressed(){
        for (var i = 0; i < 2; i++) {
